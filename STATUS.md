...
|-------|------|-------|-------|
| GenSpace (PyPI/npm, v0.13.0+) | `research/checkpoints/genspace_v0.11.1.json` | **65-9-16 / 90** | M2 L-row renormed (`0.21193779...`) so white(D65) maps to L=1 exactly |
...
- **GenSpace M2**: bundled M2 (`0.21193779...`) is renormed so white(D65) maps to L=1.0 exactly. ColorBench 65-9-16 / 90, Python ↔ JS Lab parity 5e-16.
