...
\begin{itemize}
  ...
  \item MacAdam~1974 (128~pairs, fully held-out, never seen by
    ...
    leads OKLab (32.72), Jzazbz (25.50), and DIN99 (23.28); only
    CIE94 (19.78) and CAM16-UCS (33.15) are within reasonable
    range, and v21 still leads both. This is a change from v20b,
    which had trailed CAM16-UCS on MacAdam.
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Generation/authoring mode (NC on).} For every UI
    ...
    the maximum chroma for grays drops from $\sim 0.34$ to
    $< 10^{-6}$.
\end{itemize}
...
\begin{table}[t]
  ...
  \begin{tabular}{lr}
    ...
    Human Feedback \stress (3{,}552, screen) & 23.26 \\
    \bottomrule
  \end{tabular}
\end{table}
