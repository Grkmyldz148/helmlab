...
\begin{table}[t]
  \centering
  \caption{GenSpace v0.11.1 vs OKLab --- head-to-head on ColorBench (83 internal + 7 independent gradient/palette metrics). Visual breakdown in \Cref{fig:genspace-vs-oklab}.}
...
Adopted in CSS Color Module 4 (W3C Candidate Recommendation, 2024).
